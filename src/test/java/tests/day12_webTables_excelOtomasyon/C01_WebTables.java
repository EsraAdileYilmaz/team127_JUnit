...
public class C01_WebTables extends TestBase {
    ...
    public void test01() {
        ...
        //eger locate= By.xpath("//*[@role='hrow']" ile alinirsa tum elementleri tek bir hucre elementi olarak goruyor.Ve aralarina , koymadan yazdiriyor
        ...
        //List<WebElement> tabloDataElementleriListi = driver.findElements(By.xpath("//*[@role='tdata']")); ahmet h locate
        ...
        //Tabloda kac tane satir varsa onu yazdirir
        ...
        WebElement urunFiyatElementi = driver.findElement(By.xpath("((//*[@role='trow'])[3]/*[@role='tdata'])[2]"));
        //3.satirin 2. datasi yani bu locate'le Furniture'a ulasmis olduk.Bu yolla her bir hucre bilgisi alinabilir
        ...
        /*
           ...
           fiyat degerini(yani 3.datayi) yazdiralim.
        ...
        for (int i = 1; i <= satirElementleriListi.size(); i++) {//1.satirdan baslasin her bir satiri tek tek kontrol etsin
            ...
            // i. satirdaki kategori elementinin dynamik locate'i icin==>
            satirdakiKategoriXpath = "((//*[@role='trow'])[" + i + "]/*[@role='tdata'])[2]";
            //burda herbir satirin 2.datasini(category) elde edicez ve bunlardan furniture olani secicez
            satirdakiFiyatXpath = "((//*[@role='trow'])[" + i + "]/*[@role='tdata'])[3]";
            //burda herbir satirin 3.datasini(price) elde edicez ve bunlardan furniture'in fiyatini secicez
        ...
        for (int i = 1; i <= satirElementleriListi.size(); i++) {//List<WebElement> satirElementleriListi = driver.findElements(By.xpath("//*[@role='trow']"));

            satirdakiKategoriDegeri = istenenHucredekiDatayiDondur(i, 2);//1.satirin 2.datasi,2.satirin 2.datasi,3.satirin 2.datasi ...
            satirdakiFiyatDegeri = istenenHucredekiDatayiDondur(i, 3);//1.satirin 3.datasi,2.satirin 3.datasi,3.satirin 3.datasi ...

            if (satirdakiKategoriDegeri.equals("Furniture")) {
                System.out.println("Kategorisi Furniture olan urunun fiyati : " + satirdakiFiyatDegeri);
            }
        }
    }
