...
public class C01_RadioButton {
    ...
    public void radioButtonKutuTesti(){
         ...
         WebElement radioButtonElementi= driver.findElement(By.xpath("//*[text()='Cinsiyet']"));
    ...
    public void radioButtonYaziTesti(){
         ...
         WebElement kadinRadioButtonYaziElementi=driver.findElement(By.xpath("//*[text()='Kadın']"));
